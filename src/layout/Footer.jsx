      ...
      <footer className="w-full bg-gray-200/80 backdrop-blur-sm">
        ...
        <div className="text-[#70C900] m-8 md:m-5 shadow-sm shadow-[#B8D9BE]
          ...
          <div className="flex flex-col gap-3 md:ml-2">
            ...
            <div className="flex gap-2">
              <Mail className="h-11 w-11 bg-[#70C900] hover:bg-[#D9F8E2]
            ...
            <div className="flex gap-2">
              <div className="flex items-start gap-3 sm:gap-2 w-full max-w-2xl">
                {/* Location Icon */}
               
                 <MapPin  className="shrink-0 h-10 w-10 sm:h-11 sm:w-11 md:h-11 md:w-11
                             bg-[#70C900]
                           hover:bg-[#D9F8E2] hover:text-[#071B0A] text-[#071B0A]
                             p-2 rounded-full transition-colors duration-300"/>
      

                <div className="min-w-0 flex-1">
                  <Link
                    to="https://www.google.com/maps/place/Ephorsys+Private+Limited/@20.2780638,85.769358,17z/data=!4m6!3m5!1s0x2832cd512f60df0d:0x61d1ddff084be616!8m2!3d20.2780928!4d85.7718368!16s%2Fg%2F11mrmlhhyt?authuser=0&entry=ttu&g_ep=EgoyMDI2MDgxNi4wIKXMDSoASAFQAw%3D%3D"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#70C900] hover:underline wrap-break-words">
                    Ephorsys Private Limited: 1st floor, K8/733, Kalinga Nagar,
                    Bhubaneswar, near Sum Ultimate Medicare, 751003
                  </Link>
                </div>
              </div>
            </div>
